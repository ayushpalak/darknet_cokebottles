...
ap.add_argument('-c', '--config', 
                help = 'path to yolo config file', default='data/yolov3-tiny_obj.cfg')
ap.add_argument('-w', '--weights', 
                help = 'path to yolo pre-trained weights', default='backup/yolov3-tiny_obj_3800.weights')
ap.add_argument('-cl', '--classes', 
                help = 'path to text file containing class names',default='data/obj.names')
args = ap.parse_args()
